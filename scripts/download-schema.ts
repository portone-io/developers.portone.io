...
export async function downloadV2Openapi() {
  const src =
    "https://raw.githubusercontent.com/portone-io/public-api-service/feat/payment-events-by-cursor/schema/openapi.yml";
...
export async function downloadV2Graphql() {
  const src =
    "https://raw.githubusercontent.com/portone-io/public-api-service/feat/payment-events-by-cursor/schema/schema.graphql";
