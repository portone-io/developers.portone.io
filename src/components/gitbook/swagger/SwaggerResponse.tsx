...
export default function SwaggerResponse(props: Props) {
  return (
    <details class="group/swagger border-slate-1 border-b text-sm last:border-b-0">
      <summary class="grid cursor-pointer grid-cols-[2fr_3fr_2em] gap-2 border-l-4 border-l-transparent py-4">
        ...
        <div class="chevron" role="img">
          <i class="icon-[ic--sharp-chevron-right] group-hover/swagger:text-orange inline-block"></i>
        </div>
      </summary>
      {props.children}
    </details>
