...
export default function ContentRef(props: Props) {
  ...
  return (
    <A class="m-4" href={props.slug}>
      <div class="flex items-center justify-between gap-4 rounded-sm border bg-white p-4 transition-transform hover:translate-y-[-2px] hover:text-orange-5 hover:drop-shadow-[0_12px_13px_rgba(0,0,0,0.02)]">
