...
by querying the payment transaction using the [Get Payment by ImpUid
API](../api/payment-api/get-payment-api).** Even if the payment has been successfully processed,
