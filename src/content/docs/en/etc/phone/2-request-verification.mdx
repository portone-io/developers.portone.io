...
Check the [<mark style="color:blue;">**parameters list**</mark>](../../sdk/javascript-sdk/identity-verification-request-parameters.md) for requesting the mobile identity verification window.
