...
Based on the the verification result in the response object (<mark style="color:red;">**`rsp`**</mark>)
...
Check the <mark style="color:blue;"> **value returned** </mark> when the verification is successful.
