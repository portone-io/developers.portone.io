...
The following example calls the JavaScript SDK [**IMP.certification**](../../sdk/javascript-sdk/identity-verification-request-parameters) function to open the credit card identity verification window.
