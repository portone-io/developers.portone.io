...
<Swagger method="get" path="/receipts/{imp_uid}" baseUrl="https://api.iamport.kr" summary="Gets cash receipt information issued via i'mport.">
  <SwaggerDescription />
  ...
  <SwaggerResponse status="404: Not Found" description="Transaction not found">
    ```ts
    {
      // Response
    }
