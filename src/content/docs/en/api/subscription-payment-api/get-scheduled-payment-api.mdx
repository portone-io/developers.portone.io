---
title: Get scheduled payment API
description: ''
---
...
## Gets scheduled payment data by order ID (merchant\_uid).

<Swagger method="get" path="/subscribe/payments/schedule/{merchant_uid}" baseUrl="https://api.iamport.kr" summary="Gets scheduled payment data by order ID (merchant_uid).">
  <SwaggerDescription />
  ...
  <SwaggerResponse status="200: OK" description="Success">
    <Tabs>
      <Tabs.Tab title="SingleScheduleResponse">
