...
<Swagger method="post" path="/subscribe/payments/schedule" baseUrl="https://api.iamport.kr" summary="Schedule API">
  ...
  <SwaggerResponse status="200: OK" description="Success">
    <Tabs>
      <Tabs.Tab title="ScheduleResponse">
    ...
    <Tabs>
      <Tabs.Tab title="ScheduleResultAnnotation">
        **`code`** <mark style="color:red;">**\***</mark> <mark style="color:purple;">**integer**</mark>
...
<Tabs>
  <Tabs.Tab title="Schedules Model Schema">
    ```json title="Sample"
    [
      {
...
<Details>
  <Details.Summary>Request Sample Json</Details.Summary>
