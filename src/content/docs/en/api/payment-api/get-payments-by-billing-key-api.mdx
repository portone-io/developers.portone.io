---
emoji: ⌨
title: Get payments by billing key API
description: ''
---
...
<Swagger method="get" path="/subscribe/customers/{customer_uid}/payments" baseUrl="https:/api.iamport.kr" summary="Gets payments made with the specified billing key.">
<SwaggerDescription>
...
[**https://api.iamport.kr/#!/subscribe.customer/customer\_payments**](https://api.iamport.kr/#!/subscribe.customer/customer\_payments)
