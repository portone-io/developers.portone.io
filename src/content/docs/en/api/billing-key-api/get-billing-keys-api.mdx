...
<Swagger method="get" path="/subscribe/customers" baseUrl="https://api.iamport.kr" summary="Get details of multiple billing keys.">
  <SwaggerDescription>
    Gets details (card info) of billing keys for the specified array of customer\_uid

    _s._

    Each card is mapped to a unique
