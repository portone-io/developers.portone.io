...
<Swagger method="delete" path="/subscribe/customers/{customer_uid}" baseUrl="https://api.iamport.kr" summary=" Deletes the specified billing key.">
  <SwaggerDescription>
