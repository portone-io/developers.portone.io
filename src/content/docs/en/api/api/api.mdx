...
> **Billing key**
>
> This is a unique value (merchant specified) that is mapped to the billing key issued by the PG. customer\_uid is associated with a distinct credit card number.
