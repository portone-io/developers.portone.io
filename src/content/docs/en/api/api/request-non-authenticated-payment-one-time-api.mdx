...
>
> - If there are two PG settings, Nice Payments and JTNet, set pg parameter to **nice** or
> **jtnet**. - If you have multiple Merchant IDs from Nice Payments, set pg parameter to
> **nice.MID1** or **nice.MID2**.
...
> **`customer_uid`**  <mark style="color:red;">**\***</mark>  <mark
