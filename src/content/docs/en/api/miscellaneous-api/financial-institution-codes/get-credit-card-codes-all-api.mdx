---
title: Get credit card codes (All) API
description: ''
---
...
<Swagger method="get" path="/cards" baseUrl="https://api.iamport.kr" summary="Gets both standard codes and names for all credit card companies (based on KFTC codes)">
  <SwaggerDescription />
