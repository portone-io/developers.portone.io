---
title: Get credit card name API
description: ''
---
...
<Swagger method="get" path="/cards/{card_standard_code}" baseUrl="https://api.iamport.kr" summary="Gets the credit card name for a credit card code (based on KFTC).">
  <SwaggerDescription />
