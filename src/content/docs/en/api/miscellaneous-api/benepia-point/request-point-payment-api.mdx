---
title: Request point payment API
description: ''
---
...
## Requests payment using Benepia (benefit) points.

<Swagger method="post" path="/benepia/payment" baseUrl="https://api.iamport.kr" summary="Requests payment using Benepia (benefit) points.">
  <SwaggerDescription>
    Requests payment using Benepia points through KCP by passing user's Benepia account ID and password with the payment information. Requires KCP site code.
  </SwaggerDescription>
  ...
  <SwaggerParameter name="name" type="String(40)" required="true">
    <mark style="color:red;">
      **Product name**
    </mark>
  </SwaggerParameter>
