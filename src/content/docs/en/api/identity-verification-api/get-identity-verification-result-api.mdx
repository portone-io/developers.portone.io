---
title: Get identity verification result API
description: ''
---
...
<Swagger method="get" path="/certifications/{imp_uid}" baseUrl="https://api.iamport.kr" summary="Gets identity verification result by imp_uid.">
  <SwaggerDescription />
