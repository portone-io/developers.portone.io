...
<Swagger method="post" path="/escrows/logis/{imp_uid}" baseUrl="https://api.iamport.kr" summary="Adds delivery info for an escrow transaction.">
  <SwaggerDescription>
  ...
  <SwaggerResponse status="200: OK" description="Success">
    <Tabs>
      <Tabs.Tab title="EscrowLogisResponse">
    ...
    <Tabs>
      <Tabs.Tab title="EscrowLogisAnnotation">
  ...
  <SwaggerResponse status="409: Conflict" description="Delivery info already exists or request cannot be completed">
    ```ts
    {
      // Response
    }
...
<Hint style="success">
  **Swagger Test Link**
  ...
  [**https://api.iamport.kr/#!/escrow.logis/escrow\_logis\_save**](https://api.iamport.kr/#!/escrow.logis/escrow_logis_save)
</Hint>
