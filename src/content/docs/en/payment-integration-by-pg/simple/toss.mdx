...
Refer to the [**Toss simple pay settings**](../../ready/2.-pg/pg/undefined-1.md) page to configure the PG settings.
...
<Codepen user="chaiport" slug="wvyxzYv" caption="**Toss simple payment window example**" />
