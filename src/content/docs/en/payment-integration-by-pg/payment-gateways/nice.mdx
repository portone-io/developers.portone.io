...
<Codepen
  user="chaiport"
  slug="qBxbGXy"
  caption="NICE Payments payment window"
/>
...
<Codepen
  user="chaiport"
  slug="poagmae"
  caption="Example of enabling up to 3 month installment plans"
/>
...
<Codepen
  user="chaiport"
  slug="MWQKdVo"
  caption="Example of showing only Shinhan Card in the payment window"
/>
