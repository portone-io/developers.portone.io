...
Refer to the [**Danal settings**](../../ready/2.-pg/payment-gateway-settings/undefined-2.md) page to configure the PG settings.

![](</gitbook-assets/en/screenshot 2022-05-30 5.30.00.png>)

### 2. Request payment

To open the Danal TPay payment window, call [JavaScript SDK](../../sdk/javascript-sdk/) IMP.**request\_pay**(param, callback).
...
<Codepen user="chaiport" slug="jOZZgGG" caption="
</Tab>
...
<Codepen user="chaiport" slug="WNMMVJZ" caption="Example of showing only <mark style="color:red;">**Shinhan Card**</mark> in the payment window" />
