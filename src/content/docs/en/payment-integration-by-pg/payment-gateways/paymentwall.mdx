...
Refer to the [**Paymentwall settings**](../../ready/2.-pg/payment-gateway-settings/undefined-1.md) page to configure the PG settings.

![](</gitbook-assets/en/Paymentwall\_logo\_dark\_latest.jpeg>)
...
* **country\_code** : Payment methods are shown based on this code. ([**Country codes**](https://en.wikipedia.org/wiki/ISO\_3166-1\_alpha-2))
