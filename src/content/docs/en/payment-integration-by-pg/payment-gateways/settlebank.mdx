...
Refer to the [**Settlebank settings**](../../ready/2.-pg/payment-gateway-settings/undefined-3.md) page to configure the PG settings.
...
<Codepen user="chaiport" slug="GRQdjpa" caption="Settlebank credit card payment example" />
...
<Hint style="info">
**Settlebank does not support** [**Request billing key API**](../../api/billing-key-api/api-1.md)**.**
