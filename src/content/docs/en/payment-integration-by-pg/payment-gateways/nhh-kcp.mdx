...
Refer to the [**NHN KCP settings**](../../ready/2.-pg/payment-gateway-settings/nhn-kcp.md) page to configure the PG settings.
...
How to apply: [https://sir.kr/main/service/p\_payco\_hub.php](https://sir.kr/main/service/p\_payco\_hub.php)

</Hint>

<Codepen user="chaiport" slug="NWXrGvQ" caption="
</Tab>
...
<Codepen user="chaiport" slug="oNpZEvq" caption="Example of direct call to <mark style="color:red;">**Hyundai Card**</mark> module" />
...
<Codepen user="chaiport" slug="RwxpQNq" caption="**Example of enabling only **<mark style="color:red;">**Shinhan Card**</mark>** payment window**" />
