...
#### On the checkout page, initialize the IMP object using your [Merchant ID](../../ready/3..md).
...
Once [**IMP object initialization**](2..md) is complete, you can open the payment window.

You can pass the [**parameters**](../../sdk/javascript-sdk/) required to call the payment window in the first argument of the **request\_pay** function.
...
> For information about the response parameter passed to the **callback** function, refer to [<mark style="color:red;">**rsp**</mark>](../../sdk/javascript-sdk/undefined-1.md).

<Hint style="danger">
The final payment result logic processing must be handled stably by using a [<mark style="color:red;">**webhook**</mark>](../../result/webhook.md). If you don't set up a webhook, you may fail to receive the payment result.
...
<Hint style="danger">
The payment result must be processed on the database based on the data received through a [**webhook**](../../result/webhook.md) for stable processing without any missing result data.
