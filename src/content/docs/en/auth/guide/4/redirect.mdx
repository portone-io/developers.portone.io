...
If **m\_redirect\_url** is specified as the **request\_pay** function parameter as above, the payment result is sent to the URL address in the form of a query string after <mark style="color:blue;">**payment is completed**</mark>.
