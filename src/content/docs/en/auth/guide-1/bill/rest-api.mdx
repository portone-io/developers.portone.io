...
Request for a billing key by using the i'mport [**Get billing key REST API**](../../../api/billing-key-api/get-billing-key-api) and
...
<Hint style="info">
  **Request billing key and make payment at once**
  ...
  By using the key-in payment REST API[**`/subscribe/payments/onetime`**](../../../api/api/readme), you can get the billing key and make a payment in a single API call.
</Hint>
