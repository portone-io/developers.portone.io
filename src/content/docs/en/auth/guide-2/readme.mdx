...
To request a refund, you must first get a [<mark style="color:blue;">**REST API access token**</mark>](../../api/rest-api-access-token.md). Use the **`access token`** to call the [**i'mport cancel **<mark style="color:blue;">**API**</mark>](../../api/payment-api/cancel-payment-api.md) to request a refund.
