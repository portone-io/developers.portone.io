...
결제창 호출시 필요한 [**파라미터**](../../sdk/javascript-sdk-old/)**를 request\_pay** 함수 첫번째 파라미터 인자로 설정합니다.
...
<Codepen user="chaiport" slug="NWXrGvQ" caption="결제창 예제" />

[^1]: [https://api.iamport.kr/payments/{imp\_uid}](https://api.iamport.kr/payments/%7Bimp\_uid%7D)
