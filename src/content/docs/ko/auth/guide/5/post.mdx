...
<Hint style="danger">
결제결과 DB 처리는 [**웹훅(Webhook)을 연동**](../../../result/webhook.md)하여 수신되는 데이터를 기준으로 처리하셔야 결제결과 누락없이 안정적인 결과처리를 완료하실 수 있습니다.

</Hint>

<Hint style="info">
[**Confirm Process**](../../../tip/confirm-process.md) 기능을 사용하여서도 결제금액 검증을 할 수 있습니다.
