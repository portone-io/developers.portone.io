...
import V2SdkInstallation from "./_components/v2-sdk-installation.mdx";
...
결제창에서의 작업이 끝나면 지정한
<VersionGate><span slot="v1">`m_redirect_url`</span><span slot="v2">`redirectUrl`</span></VersionGate>로
다시 리다이렉트됩니다.
