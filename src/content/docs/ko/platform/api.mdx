...
{"transfer": {"type": "ORDER",
  ...
  "orderLines": [{"product": {"id": "1", "name": "product_1", "amount": 5000},
    "quantity": 5,
    "discounts": [{"sharePolicy": {"id": "discount_1",
      ...
      "amount": 2500,
      "shareAmount": 1250}],
    "additionalFees": [{"policy": {"id": "addtional_fee_1",
...
`POST https://plublic-api-service.iamport.co/platform/transfers/order`
...
가맹점 주문 아이디. 포트원 결제일 경우 포트원 결제에 전달해주시는 merchant_uid (v1) 혹은 payment_id(v2) 를 전달하셔야 합니다.
외부결제 일 경우 단순히 가맹점 주문번호를 전달해주시면 됩니다.
...
`POST https://plublic-api-service.iamport.co/platform/transfers/order-cancel`
...
`POST https://plublic-api-service.iamport.co/platform/transfers/manual`
...
`GET https://plublic-api-service.iamport.co/platform/transfers/{id}`
...
`POST https://plublic-api-service.iamport.co/platform/contracts`
...
`GET https://plublic-api-service.iamport.co/platform/contracts{id}`
...
`PATCH https://plublic-api-service.iamport.co/platform/contracts/{id}`
...
`GET https://plublic-api-service.iamport.co/platform/contracts`
...
`POST https://plublic-api-service.iamport.co/platform/contracts/{id}/schedule`
...
`PUT https://plublic-api-service.iamport.co/platform/contracts/{id}/schedule`
...
`GET https://plublic-api-service.iamport.co/platform/contracts/{id}/schedule`
...
`DELETE https://plublic-api-service.iamport.co/platform/contracts/{id}/schedule`
...
`POST https://plublic-api-service.iamport.co/platform/partners`
...
`GET https://plublic-api-service.iamport.co/platform/partners/{id}`
...
`GET https://plublic-api-service.iamport.co/platform/partners`
...
`PATCH https://plublic-api-service.iamport.co/platform/partners/{id}`
...
`POST https://plublic-api-service.iamport.co/platform/partners/{id}/schedule`
...
`PUT https://plublic-api-service.iamport.co/platform/partners/{id}/schedule`
...
`DELETE https://plublic-api-service.iamport.co/platform/partners/{id}/schedule`
...
`POST https://plublic-api-service.iamport.co/platform/discount-share-policies`
...
`GET https://plublic-api-service.iamport.co/platform/discount-share-policies/{id}`
...
`GET https://plublic-api-service.iamport.co/platform/discount-share-policies`
...
`PATCH https://plublic-api-service.iamport.co/platform/discount-share-policies/{id}`
...
`DELETE https://plublic-api-service.iamport.co/platform/discount-share-policies/{id}`
...
`POST https://plublic-api-service.iamport.co/platform/discount-share-policies/{id}/schedule`
...
`PUT https://plublic-api-service.iamport.co/platform/discount-share-policies/{id}/schedule`
...
`POST https://plublic-api-service.iamport.co/platform/additional-fee-policies`
...
`PATCH https://plublic-api-service.iamport.co/platform/additional-fee-policies`
...
`PATCH https://plublic-api-service.iamport.co/platform`
...
`GET https://plublic-api-service.iamport.co/platform`
