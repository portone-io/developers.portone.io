...
웹훅 수신주소는 공개된 URL이기 때문에 **요청자 클라이언트(client IP)가 포트원(PortOne IP)인지 반드시 확인**해야 합니다. 포트원 웹훅은 다음의 두 가지 **고정된 IP** 로 부터 요청이 생성됩니다.
...
<figure><img src="/gitbook-assets/ko/ngrok.gif" alt=""/><figcaption><p>ngrok 사용 예시</p></figcaption></figure>
