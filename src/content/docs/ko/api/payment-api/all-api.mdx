...
<SwaggerResponse status="400: Bad Request" description="merchant_uid누락, 올바르지 않은 status 등 파라미터가 잘못된 경우">
```ts
{
    // Response
}
...
<SwaggerResponse status="404: Not Found" description="유효하지 않은 merchant_uid">
```ts
{
    // Response
}
