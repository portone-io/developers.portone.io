...
### 복수의 포트원 고유번호 또는 고객사 주문번호로 결제내역을 조회합니다.

<Swagger method="get" path="/payments" baseUrl="https://api.iamport.kr" summary="여러 개의 거래고유번호 또는 고객사 주문번호로 결제내역을 한 번에 조회합니다">
<SwaggerDescription>
**호출예시**\
...
<SwaggerResponse status="404: Not Found" description="해당되는 결제건을 찾지 못하였습니다.">
```ts
{
    // Response
}
