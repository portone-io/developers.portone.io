...
포트원을 통해 발생된 현금성 거래(**가상계좌, 게좌이체**)의 포트원 거래고유번호(<mark style="color:red;">**`imp_uid`**</mark>)를 기준으로 현금영수증이 발급 됩니다.
...
(KG이니시스/NHN KCP/나이스페이먼츠/키움페이(구 다우, 페이조아)는 identifier 만으로 자동 처리)
