...
### 수납번호(barcode)로 결제가 이뤄지지 않도록 말소처리하는 API입니다.

<Swagger method="delete" path="/cvs/{imp_uid}" baseUrl="https://api.iamport.kr" summary="수납번호 취소">
<SwaggerDescription>
...
<mark style="color:red;">**포트원 거래고유번호**</mark>

편의접결제 수납번호(barcode) 발급/등록된 포트원 거래고유번호
