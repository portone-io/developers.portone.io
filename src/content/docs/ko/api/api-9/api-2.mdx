...
<SwaggerParameter name="amount" type="integer" required="false">
**발급금액**

</SwaggerParameter>
<SwaggerParameter name="vbank_due" type="integer" required="false">
**입금기한**
...
<SwaggerResponse status="400: Bad Request" description="imp_uid가 누락된 경우">
```javascript
{
    // Response
}
