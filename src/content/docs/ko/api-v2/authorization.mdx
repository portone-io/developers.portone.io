...
<Swagger method="post" path="/token-regeneration" baseUrl="https://api.portone.io" summary="토큰 재발급">
<SwaggerDescription>
리프레시 토큰을 이용한 토큰 재발급
</SwaggerDescription>
### Parameters
...
<Swagger method="post" path="/signin/api-key" baseUrl="https://api.portone.io" summary="API Key 방식으로 로그인">
<SwaggerDescription>
API Key 방식으로 로그인
</SwaggerDescription>
### Parameters
