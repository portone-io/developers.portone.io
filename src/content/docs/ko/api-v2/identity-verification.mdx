...
<Swagger method="post" path="/identity-verifications/send" baseUrl="https://api.portone.io" summary="본인인증 요청 전송">
<SwaggerDescription>
본인인증 요청을 전송합니다.
...
<Swagger method="post" path="/identity-verifications/confirm" baseUrl="https://api.portone.io" summary="본인인증 확인">
<SwaggerDescription>
...
<Swagger method="post" path="/identity-verifications/resend" baseUrl="https://api.portone.io" summary="본인인증 요청 재전송 (SMS)">
<SwaggerDescription>
본인인증 요청을 재전송합니다.
