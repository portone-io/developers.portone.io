...
<Swagger method="post" path="/payments/pre-register" baseUrl="https://api.portone.io/v2" summary="결제 정보 사전 등록">
<SwaggerDescription>SDK 방식의 결제를 진행할 때 결제 금액 위변조시 결제 진행을 막기 위해 결제 예정 금액을 사전 등록하는 기능입니다. 동일한 `paymentId` 여러 번의 호출 시 가장 마지막으로 성공한 금액으로 검증합니다.</SwaggerDescription>
...
<SwaggerParameter name="paymentId" type="string" required="true">
결제건 아이디

</SwaggerParameter>
<SwaggerParameter name="currency" type="Currency" required="false">
...
<SwaggerParameter name="totalAmount" type="integer" required="false">
결제 총 금액

</SwaggerParameter>
<SwaggerParameter name="taxFreeAmount" type="integer" required="false">
결제 면세 금액

</SwaggerParameter>
### Responses

<SwaggerResponse status="200" description="결제 정보 사전 등록 성공 응답">
<Tabs>
<Tab title="Response">
</Tab>
</Tabs>
