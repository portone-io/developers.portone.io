...
포트원에서 제공하는 Server SDK를 이용하면 고객사 서버에서 웹훅을 수신할 때 signature가 유효한지를 손쉽게 verify할 수 있습니다.
현재 제공되고 있는 Server SDK 목록은 아래와 같습니다.

- server-sdk-jvm [(GitHub 링크)](https://github.com/portone-io/server-sdk-jvm)
- server-sdk-js [(GitHub 링크)](https://github.com/portone-io/server-sdk-js) [(예시 코드)](https://github.com/portone-io/server-sdk-js/blob/main/examples/express/index.js)
...
준수하고 있으므로, 해당 스펙에서 안내된 대로 verify 코드를 작성하시면 됩니다.
