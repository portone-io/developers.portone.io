...
1. 포트원 API를 사용하기 위한 액세스 토큰 발급 받기 [#api-key-1](../../api-v2/authorization.md#api-key-1 "mention")
2. 포트원 결제내역 단건조회 API 호출 [#undefined](../../api-v2/payment.md#undefined "mention")
