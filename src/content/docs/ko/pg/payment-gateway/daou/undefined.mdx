...
<Details>
  <p slot="summary">사파리 브라우저 - 하나카드 / NH앱캐시 결제시 유의사항</p>
...
<Details>
  <p slot="summary">사파리/파이어폭스 브라우저 - BC카드 결제시 유의사항</p>
...
<Details>
  <p slot="summary">실시간 계좌이체 유의사항 </p>
...
<Details>
  <p slot="summary">가상계좌 입금 완료시, 송금자 이름 정보만 저장됨</p>
...
<Details>
  <p slot="summary">과세/면세/복합과세를 하나의 CPID로 이용하시는 경우</p>
...
<Details>
  <p slot="summary">에스크로 결제 시 구매자 전화번호 자동 입력 불가</p>
...
<Details>
  <p slot="summary">비인증 결제 API 호출시 초당 호출 횟수 제한</p>
