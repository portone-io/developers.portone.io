...
[**KG이니시스 설정**](../../ready/2.-pg/payment-gateway/kg.md) 페이지의 내용을 참고하여 PG 설정을 진행합니다.

![](</gitbook-assets/ko/7043\_14679\_1310.jpeg>)

### 2.결제 요청하기

[JavaScript SDK](../../sdk/javascript-sdk-old/) IMP.**request\_pay**(param, callback)을 호출하여 KG이니시스 결제창을 호출할 수 있습니다. **결제결과**는 PC의 경우 IMP.request\_pay(param, callback) 호출 후 <mark style="color:red;">**callback**</mark> 으로 수신 되며 모바일의 경우<mark style="color:red;">**m\_redirect\_url**</mark> 로 리디렉션됩니다.
...
<Codepen user="chaiport" slug="gOvoxpw" caption="
</Tab>
...
<Codepen user="chaiport" slug="Yzewbeg" />
...
* **vat\_amount**: 상점아이디(MID)에 영세율 설정된 경우 부가세(vat\_amount) 및 면세금액(tax\_free)를 0원으로 지정하여 영세율 결제 가능
