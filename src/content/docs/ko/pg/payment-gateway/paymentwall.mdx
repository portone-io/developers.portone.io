...
[**페이먼트월 설정**](../../ready/2-pg/payment-gateway/paymentwall) 페이지의 내용을 참고하여 PG 설정을 진행합니다.
...
호출 후 <mark style="color:red;">**callback**</mark> 으로 수신되며 모바일의 경우<mark
style="color:red;">**m_redirect_url**</mark> 로 리디렉션됩니다.
...
`customer_uid`를 가맹점 내부서버에 저장한 후 [<mark style="color:blue;">**비 인증 결제요청 REST API**</mark>](../../api/api-4/api)를 호출하여 결제 요청을 해야합니다.
