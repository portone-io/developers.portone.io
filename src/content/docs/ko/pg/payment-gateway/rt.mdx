---
emoji: ⌨
title: 페이팔 정기결제 빌링키 발급
description: 페이팔 정기결제 빌링키 발급 연동 방법을 안내합니다.
---
...
<Hint style="warning">
페이팔 정기결제 빌링키 발급은 **SDK 1.3.0 부터 사용 가능**합니다.
...
페이팔 연동시에 사용되는 신규 JS SDK는 기존 모듈에서 제공했던 CallBack 파라미터가 대부분 삭제되었습니다.(특히 deprecated 로 명시된 파라미터는 모두 삭제되었습니다.)
...
위 JS SDK 를 이용하여 토스페이먼츠,케이에스넷,페이팔 정기결제 연동시 callback Data는
...
| [pay_method](https://chaifinance.notion.site/pay_method-9edc2ae955d2434996bb0c3f1c53802b) | string     | optional | 빌링키 발급 수단                                                                                                                                                                                                               |
...
정기결제 기능을 사용하시기 위해 다음 정보를 확인하셔야 합니다.
