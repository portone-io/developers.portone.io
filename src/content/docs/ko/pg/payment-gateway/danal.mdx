...
[**다날 설정**](../../ready/2.-pg/payment-gateway/undefined.md) 페이지의 내용을 참고하여 PG 설정을 진행합니다.

![](</gitbook-assets/ko/스크린샷 2022-05-30 오후 5.30.00.png>)

### 2.결제 요청하기

<Tabs>
<Tab title="인증결제창 호출">
[JavaScript SDK](../../sdk/javascript-sdk-old/) IMP.**request\_pay**(param, callback)을 호출하여 다날 Tpay 결제창을 호출할 수 있습니다. **결제결과**는 PC/모바일 환경 모두 경우 IMP.request\_pay(param, callback) 호출 후 <mark style="color:red;">**callback**</mark> 으로 수신됩니다.
...
<pre class="language-javascript" data-title="Javascript SDK"><code class="lang-javascript"><strong>IMP.request_pay({
</strong>   pg : 'danal_tpay.{CPID}',
