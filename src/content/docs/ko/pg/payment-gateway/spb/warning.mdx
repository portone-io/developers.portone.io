...
emoji: 😲
title: 연동 유의사항
description: 페이팔 이용시 특이사항을 확인할수 있습니다.
---
...
페이팔은 <mark style="color:red;">**구매자가 접속한 나라에 따라 이용 가능한 결제 수단이 달라지는 방식**</mark>입니다. 따라서 구매자가 접속한 나라에 따라 렌더링 되는 버튼의 종류와 개수가 달라집니다.

![](</gitbook-assets/ko/image (3) (1).png>)![](</gitbook-assets/ko/image (47).png>)
...
페이팔에 가입되어있지 않은 구매자도 비회원으로 결제가 가능하지만, 회원으로 로그인 했을때와 사용 가능한 결제 수단과 렌더링 되는 결제창에 다소 차이가 있습니다. 회원 / 비회원간 적용/사용 가능한 기능 차이를 간략하게 정리하면 아래와 같습니다.

<img src="/gitbook-assets/ko/image (38).png" alt="" data-size="original"/>
...
페이팔은 할부 결제를 Pay Later로 부르고 있습니다. 포트원은 Pay Later를 버튼 형태로 제공하고 있으며, **해당 버튼을 렌더링 하기 위해서는 enable-funding 파라미터에 `paylater` 값을 반드시 넣어주셔야** 합니다. 넣지 않으면 Pay Later를 지원하는 국가에서 접속한다고 하더라도 자동으로 렌더링 되지 않습니다. (단, 미국 제외)
...
<Figure src="/gitbook-assets/ko/image (23) (1).png" caption="접속 국가: 벨기에 enable-funding: “paylater” → 아무 버튼도 렌더링 되지 않음" /><Figure src="/gitbook-assets/ko/image (12).png" caption="접속 국가: 프랑스  enable-funding: “paylater” → 4X Paypal 버튼이 렌더링 됨" /><Figure src="/gitbook-assets/ko/image (15) (1).png" caption="!\[접속 국가: 이탈리아 enable-funding: “paylater” → Paga in 3 rate 버튼이 렌더링 됨\](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/82168769-9bac-4901-b407-bb655ce1679c/Untitled.png)  접속 국가: 이탈리아 enable-funding: “paylater” → Paga in 3 rate 버튼이 렌더링 됨" />
...
* **US(미국) / USD(달러)**
  *   Pay in 4
      ...
      *   자세히 보기 (ex. 700달러 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/acc5bc45-cafc-4e75-a524-e450957505ce/Untitled.png)
  *   Pay Monthly
      ...
      *   자세히 보기 (ex. 700달러 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c7c3f372-0a34-41f0-a815-2d5c3b9d6308/Untitled.png)
* **AU(호주) / AUD(호주 달러)**
  *   Pay in 4\*\*\*\*
      ...
      *   자세히 보기 (ex. AUD 호주 달러 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/f4f4c7d2-cf5d-4866-b01b-8995bbf84b69/Untitled.png)
* **GE(독일) / EUR(유로화)**
  *   PayPal Ratenzahlung
      ...
      *   자세히 보기 (ex. 700 유로 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/31cf7e44-e640-438f-9622-96c75852d8c0/Untitled.png)
  *   Pay in 30
...
* **ES(스페인) / EUR(유로화)**
  *   Pay in 3 installments
      ...
      *   자세히 보기 (ex. 700 유로 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2f9b28c1-8827-4379-8334-3556c29f864f/Untitled.png)
* **IT(이탈리아) / EUR(유로화)**
  *   Pay in 3 installments
      ...
      *   자세히 보기 (ex. 700 유로 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/897a5e73-1301-4f45-af1a-a6638a946181/Untitled.png)
* **FR(프랑스) / EUR(유로화)**
  *   Pay in 4X
      ...
      *   자세히 보기 (ex. 700유로 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8b2f9dd7-8301-4435-b4f0-db4cfe9eb95f/Untitled.png)
* **GB(영국) / GBP(영국 파운드화)**
  *   Pay in 3
      ...
      *   자세히 보기(ex. 700 파운드 결제)
          ...
          ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/b570364a-807e-48df-89f5-a4b6e56aa8a4/Untitled.png)
...
가입 후 부여 받은 페이팔 Account ID(IMP.loadUI 함수 호출시 pg 파라미터로 전달)가 각각 D, E, I라고 한다면, **가맹점은 구매자가 접속한 국가에 따라 올바른 Account ID를 전달해야** 합니다. 즉, 구매자가 독일에서 접속 한 경우엔 pg: “paypal\_v2.D”, 스페인에서 접속 한 경우에는 pg: “paypal\_v2.E” 마지막으로 이탈리아에서 접속 한 경우에는 pg: “paypal\_v2.I”로 입력해줘야합니다.
...
<Figure src="/gitbook-assets/ko/image (51).png" caption="프랑스용 Pay Later 버튼을 누르고 미국으로 설정 된 페이팔 계정으로 로그인 한 경우, 미국의 Pay Later 정책(Pay in 4, Pay Monthly)이 적용 된 화면이 렌더링 됨 (언어도 영어)" /><Figure src="/gitbook-assets/ko/image (58).png" caption="프랑스용 Pay Later 버튼을 누르고 프랑스로 설정 된 페이팔 계정으로 로그인 한 경우, 정상적으로 프랑스의 Pay Later 정책이 적용 된 화면이 렌더링 됨 (언어도 프랑스어)" />
...
![](</gitbook-assets/ko/image (53).png>)
...
![](</gitbook-assets/ko/image (26).png>)
...
![](</gitbook-assets/ko/image (62).png>)![](</gitbook-assets/ko/image (56).png>)

회원으로 결제시에는 결제창에 표기되지 않습니다.

![](</gitbook-assets/ko/image (66).png>)![](</gitbook-assets/ko/image (52).png>)
...
![](</gitbook-assets/ko/image (6) (1).png>)
...
![](</gitbook-assets/ko/image (31) (1).png>)![](</gitbook-assets/ko/image (71).png>)
...
![](</gitbook-assets/ko/image (13).png>)
...
![](</gitbook-assets/ko/image (34).png>)![](</gitbook-assets/ko/image (1) (1).png>)
...
![](</gitbook-assets/ko/image (55).png>)

<Figure src="/gitbook-assets/ko/image (29).png" caption="접속 국가: 독일 enable-funding: “paylater”" /><Figure src="/gitbook-assets/ko/image (81).png" caption="접속 국가: 독일 enable-funding: “paylater”" />

<Figure src="/gitbook-assets/ko/image (75).png" caption="접속 국가: 한국" /><Figure src="/gitbook-assets/ko/image (2) (2).png" caption="접속 국가: 이탈리아 enable-funding: “paylater”" />
...
<Figure src="/gitbook-assets/ko/image (36).png" caption="접속 국가: 이탈리아 enable-funding: “paylater”" /><Figure src="/gitbook-assets/ko/image (25).png" caption="접속 국가: 이탈리아 enable-funding: “paylater” disable-funding: “mybank”" />
...
&#x20;💡 포트원을 통해 페이팔을 연동하는 가맹점은 **purchase\_units의 길이가 항상 0 또는 1이어야** 합니다.
...
<Figure src="/gitbook-assets/ko/image (11) (1).png" caption="\[체크박스 선택 된 모습\] payer 정보 없이 shipping 정보만 입력한 경우, 청구 주소에 shipping 정보가 자동 입력됩니다." /><Figure src="/gitbook-assets/ko/image (5) (3).png" caption="\[체크박스 해제 된 모습\] payer 정보 없이 shipping 정보만 입력한 경우, 청구 주소와 배송 주소에 모두 shipping 정보가 자동 입력됩니다." />
...
<Figure src="/gitbook-assets/ko/image (45).png" caption="\[체크박스 선택 된 모습\] payer 정보와 shipping 정보를 모두 입력한 경우, 청구 주소란에 payer 정보가 자동 입력됩니다." /><Figure src="/gitbook-assets/ko/image (68).png" caption="!\[\[체크박스 해제 된 모습\] payer 정보와 shipping 정보를 모두 입력한 경우, payer 정보는 청구 주소란에 shipping 정보는 배송 주소란에 정상적으로 자동 입력됩니다.\](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/9aed98ae-a59b-4606-b378-dabc5e61acdf/Untitled.png)  \[체크박스 해제 된 모습\] payer 정보와 shipping 정보를 모두 입력한 경우, payer 정보는 청구 주소란에 shipping 정보는 배송 주소란에 정상적으로 자동 입력됩니다." />
...
💡 <mark style="color:red;">**청구 주소 정보 중**</mark><mark style="color:red;">** **</mark><mark style="color:red;">**`country_code`**</mark><mark style="color:red;">**는 필수 입력입니다.**</mark>
...
*   **페이팔 회원으로 결제시**
    ...
    *   payer.address 정보 입력
        ...
        ![](</gitbook-assets/ko/image (3) (3).png>)
...
*   **페이팔 비회원으로 결제시**
    ...
    *   payer.address 정보 입력
    ...
    ![](</gitbook-assets/ko/image (14).png>)
...
단, 이때의 주소는 총 5개의 영역으로 나누어진 상세 주소로 기존에 포트원이 제공하던 buyer\_addr 파라미터로는 커버가 불가능하므로 페이팔 전용 파라미터([bypass.paypal\_v2.payer.address](https://www.notion.so/7dc573ea6c5e45de9c00d2bb7b732855))를 사용하셔야 합니다. 자세한 내용은 관련 문서를 참고해주세요.

<Figure src="/gitbook-assets/ko/image (77).png" caption="회원으로 결제시 청구 주소는 노출되지 않고 배송 주소만 노출되는 모습" /><Figure src="/gitbook-assets/ko/image (40).png" caption="비회원으로 결제시 전달한 파라미터대로 청구 주소가 자동 입력 된 화면" />
