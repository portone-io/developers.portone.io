...
<Hint style="danger">
Paypal Express checkout 신규 신청 및 신규 연동이 불가합니다. 페이팔 연동을 원하는 경우, [페이팔 SPB(Smart Payment Buttons) 연동 방법](spb)으로 진행 바랍니다.
...
[JavaScript SDK](../../sdk/javascript-sdk-old/readme) IMP.**request_pay**(param, callback)을 호출하여 페이팔 결제창을 호출할 수 있습니다. **결제결과**는 **PC / 모바일** 모두 <mark style="color:red;">**m_redirect_url**</mark> 리디렉션됩니다.
