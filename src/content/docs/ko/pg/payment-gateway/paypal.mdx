...
<Hint style="danger">
Paypal Express checkout 신규 신청 및 신규 연동이 불가합니다. 페이팔 연동을 원하는 경우, [페이팔 SPB(Smart Payment Buttons) 연동 방법](spb.md)으로 진행 바랍니다.

</Hint>

### 1. 페이팔 PG 설정하기

[**페이팔 설정**](../../ready/2.-pg/payment-gateway/undefined-3.md) 페이지의 내용을 참고하여 PG 설정을 진행합니다.

![](</gitbook-assets/ko/screenshot 2022-06-03 1.01.05.png>)

### 2.결제 요청하기

[JavaScript SDK](../../sdk/javascript-sdk-old/) IMP.**request\_pay**(param, callback)을 호출하여 페이팔 결제창을 호출할 수 있습니다. **결제결과**는 **PC / 모바일** 모두 <mark style="color:red;">**m\_redirect\_url**</mark> 리디렉션됩니다.
