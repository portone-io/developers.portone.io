...
![](</gitbook-assets/ko/screenshot 2022-05-29 7.53.40.png>)

### 2.결제 요청하기

[JavaScript SDK](../../sdk/javascript-sdk-old/) IMP.**request\_pay**(param, callback)을 호출하여 NHN KCP 결제창을 호출할 수 있습니다. **결제결과**는 PC의 경우 IMP.request\_pay(param, callback) 호출 후 <mark style="color:red;">**callback**</mark> 으로 수신되고 모바일의 경우 <mark style="color:red;">**m\_redirect\_url**</mark> 로 리디렉션됩니다.

<Tabs>
<Tab title="인증결제 연동하기">
<pre class="language-javascript" data-title="Javascript SDK" data-line-numbers><code class="lang-javascript"><strong>IMP.request_pay({
</strong>    pg : 'kcp.{사이트코드}',   //테스트인경우 kcp.T0000
    pay_method : 'card',
...
<Tab title="특정 카드사 노출">
<pre class="language-javascript" data-title="javascript"><code class="lang-javascript"><strong>card : {
</strong>    detail : [
