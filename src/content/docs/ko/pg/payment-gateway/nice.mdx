...
![](</gitbook-assets/ko/screenshot 2022-05-29 7.44.33.png>)

### 2.결제 요청하기

[JavaScript SDK](../../sdk/javascript-sdk-old/) IMP.**request\_pay**(param, callback)을 호출하여 NICE페이먼츠 결제창을 호출할 수 있습니다. **결제결과**는 PC의 경우 IMP.request\_pay(param, callback) 호출 후 <mark style="color:red;">**callback**</mark> 으로 수신되고 모바일의 경우<mark style="color:red;">**m\_redirect\_url**</mark> 로 리디렉션됩니다.
...
<Codepen user="chaiport" slug="poagmae" caption="할부개월수 <mark style="color:red;">**3개월**</mark>**까지 활성화 예제**" />
...
<Codepen user="chaiport" slug="Yzewbeg" caption="<mark style="color:red;">**현대카드**</mark> 결제모듈 바로 호출 예제" />
...
<Codepen user="chaiport" slug="MWQKdVo" caption="<mark style="color:red;">**신한카드**</mark>**만 결제창 노출 처리 예제**" />
...
* **vat\_amount**: 상점 아이디 설정이 지정금액 방식인 경우 부가세 지정 가능(integer)
