...
[JavaScript SDK](../../sdk/javascript-sdk-old/readme) `IMP.request_pay(param, callback)`을 호출하여 NICE페이먼츠 결제창을 호출할 수 있습니다. **결제결과**는 PC의 경우 `IMP.request_pay(param, callback)` 호출 후 <mark style="color:red;">**callback**</mark> 으로 수신되고 모바일의 경우 <mark style="color:red;">**m\_redirect\_url**</mark> 로 리디렉션됩니다.
...
<Tabs>
  <Tab title="할부개월수 설정">
    ...
    **파라미터 설명**
    ...
    <Codepen user="chaipor" slug="poagmae" caption="할부개월수 3개월까지 활성화 예제**" />
  </Tab>
