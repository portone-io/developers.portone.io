...
[JavaScript SDK](../../sdk/javascript-sdk-old/readme) IMP.**request_pay**(param, callback)을 호출하여 알리페이 결제창을 호출할 수 있습니다. **결제결과**는 <mark style="color:red;">**m_redirect_url**</mark> 로 리디렉션됩니다.
