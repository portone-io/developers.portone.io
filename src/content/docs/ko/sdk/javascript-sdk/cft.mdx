...
> **고객 이름**
>
> 본인인증 화면 내 이름 필드에 자동입력됨(<mark style="color:red;">다날 PG사 본인인증만 지원</mark>)

> **`phone`** <mark style="color:green;">**string**</mark>
>
> **고객 전화번호**
>
> 본인인증 화면 내 전화번호 필드에 자동입력됨(<mark style="color:red;">다날 PG사 본인인증만 지원</mark>)

> **`carrier`** <mark style="color:green;">**string**</mark>
>
> **본인인증 통신사**
>
> 본인인증 화면에서 선택 가능한 통신사 설정(<mark style="color:red;">다날 PG사 본인인증만 지원</mark>)
>
> * SKT : `SKT`
> * KT : `KTF`
> * LGU+ : `LGT`
