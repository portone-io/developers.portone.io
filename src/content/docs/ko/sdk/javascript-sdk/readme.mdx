...
<Hint style="info">
기존에 사용하신 JavaScript SDK의 문서를 원하시면 [javascript-sdk-old](../javascript-sdk-old/ "mention")를 참고해주세요.\
...
포트원 REST API로 [결제 상세 내역을 조회](../../api/api-1/api-7.md)해야 결제 성공 여부를 받을 수 있습니다.
