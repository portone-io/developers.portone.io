...
<Figure src="/gitbook-assets/ko/image (36) (1).png" caption="상점 계정관리 -> 내 식별코드 API Keys 선택" />

<Figure src="/gitbook-assets/ko/image (57).png" caption="가맹점 식별코드/REST API Key/ REST API Secret 확인" />
