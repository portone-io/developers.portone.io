...
2. 결제연동 탭 클릭
3. 결제 대행사 설정에 테스트 → 페이코 → 페이코 선택후 오른쪽 **추가** 버튼 클릭

<Figure
  src="/gitbook-assets/ko/payco-channel-guide-1.png"
  caption="테스트 환경 설정 예시"
/>
4. 아래 MID확인 후 저장

- **페이코 간편결제 결제창** 테스트 PARTNERTEST
- **페이코 간편결제 Recurring 결제창** 테스트 AUTOPAY (정기결제)

<Figure
  src="/gitbook-assets/ko/payco-channel-guide-2.png"
...
1. [포트원 관리자 콘솔 로그인](https://admin.portone.io/integration)
2. 결제연동 탭 클릭
3. 결제 대행사 설정에 실연동 → 페이코 → 페이코  선택후 오른쪽 **추가** 버튼 클릭

<Figure
  src="/gitbook-assets/ko/payco-channel-guide-3.png"
  caption="실환경 상세 설정 예시"
/>

4. 카드사 심사 완료 후 페이코에서 발급받은 실상점 정보를 설정합니다.

<Figure
  src="/gitbook-assets/ko/payco-channel-guide-4.png"
  caption="실환경 설정 예시"
/>
