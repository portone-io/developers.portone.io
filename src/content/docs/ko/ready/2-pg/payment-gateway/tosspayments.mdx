...
3. 결제 대행사 설정에서 토스페이먼츠 / 토스페이먼츠 선택 후 오른쪽 `+ 추가` 버튼 클릭
   ...
   <Figure src="/gitbook-assets/ko/image (181) (2).png" />

4. 테스트 연동 정보 확인 후 오른쪽 하단 `저장` 버튼 클릭

<Figure src="/gitbook-assets/ko/image (1) (2) (1).png" />
...
3. 결제 대행사 설정에서 토스페이먼츠 / 토스페이먼츠 선택 후 오른쪽 `+ 추가` 버튼 클릭\
   ...
   <Figure src="/gitbook-assets/ko/image (177) (1).png" />

4. 테스트 연동 정보 확인 후 오른쪽 하단 `저장` 버튼 클릭\

   <Figure src="/gitbook-assets/ko/image (185) (2).png" />
...
<Figure
  src="/gitbook-assets/ko/image (40) (1).png"
  caption="결제연동 -> 테스트 연동관리 -> 토스페이먼츠 -> (구)토스페이먼츠 ->추가"
/>

<Figure
  src="/gitbook-assets/ko/image (47) (1).png"
  caption="자동으로 설정된 테스트 MID 확인후 저장"
/>
...
<Figure
  src="/gitbook-assets/ko/image (1) (1) (1) (1).png"
  caption="결제연동 -> 실 연동관리 선택"
/>

<Figure
  src="/gitbook-assets/ko/image (275).png"
  caption="토스페이먼츠 -> (구) 토스페이먼츠 선택 -> 추가"
/>

<Figure
  src="/gitbook-assets/ko/image (82).png"
