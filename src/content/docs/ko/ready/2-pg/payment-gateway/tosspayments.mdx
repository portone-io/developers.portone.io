...
<figure><img src="/gitbook-assets/ko/image (184) (2).png" alt=""/><figcaption></figcaption></figure>
...
3.  결제 대행사 설정에서 토스페이먼츠 / 토스페이먼츠 선택 후 오른쪽 `+ 추가` 버튼 클릭
    ...
    <figure><img src="/gitbook-assets/ko/image (181) (2).png" alt=""/><figcaption></figcaption></figure>
4. 테스트 연동 정보 확인 후 오른쪽 하단 `저장` 버튼 클릭

<figure><img src="/gitbook-assets/ko/image (1) (2) (1).png" alt=""/><figcaption></figcaption></figure>
...
3.  결제 대행사 설정에서 토스페이먼츠 / 토스페이먼츠 선택 후 오른쪽 `+ 추가` 버튼 클릭\\
    ...
    <figure><img src="/gitbook-assets/ko/image (177) (1).png" alt=""/><figcaption></figcaption></figure>
4.  테스트 연동 정보 확인 후 오른쪽 하단 `저장` 버튼 클릭\\

    <figure><img src="/gitbook-assets/ko/image (185) (2).png" alt=""/><figcaption></figcaption></figure>
...
<Figure src="/gitbook-assets/ko/image (40) (1).png" caption="결제연동 -> 테스트 연동관리 -> 토스페이먼츠 -> (구)토스페이먼츠 ->추가" />

<Figure src="/gitbook-assets/ko/image (47) (1).png" caption="자동으로 설정된 테스트 MID 확인후 저장" />
...
<Figure src="/gitbook-assets/ko/image (1) (1) (1) (1).png" caption="결제연동 -> 실 연동관리 선택" />

<figure><img src="/gitbook-assets/ko/image (275).png" alt=""/><figcaption><p><strong>토스페이먼츠</strong> -> <mark style="color:red;"><strong>(구) 토스페이먼츠</strong></mark> 선택 -> <strong>추가</strong></p></figcaption></figure>

<img src="/gitbook-assets/ko/image (82).png" alt="토스페이먼츠와 계약 후 발급된 연동상점정보(MID/ MertKey)를 기재" data-size="original"/>
