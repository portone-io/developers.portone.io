...
description: (구)페이팔(Express checkout) 설정 방법을 안내합니다.
---
...
<Hint style="danger">
(구) Paypal Express checkout 신규 신청 및 신규 연동이 불가합니다.
...
1. [https://www.paypal.com/](https://www.paypal.com/) 로그인> 우측 상단의 계정 클릭 > 계정 설정 에서 "계정 액세스" 메뉴의 "API 액세스"의 업데이트 클릭
   <Figure src={image9} />
