...
<Figure
  src="/gitbook-assets/ko/paymentwall.tab.widget.png"
  caption="My Projects → 프로젝트 선택 → Widgets 선택"
/>

<Figure
  src="/gitbook-assets/ko/paymentwall.widget.jpg"
  caption="좌측 상단 Version에서 1.2 선택 → SAVE CHANGES"
/>
