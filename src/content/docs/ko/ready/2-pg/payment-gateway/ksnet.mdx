...
3.  결제 대행사 설정에서 KSNET / KSNET 선택 후 오른쪽 `+ 추가` 버튼 클릭
    ...
    <figure><img src="/gitbook-assets/ko/ksnet-setup-test.png" alt=""/><figcaption></figcaption></figure>
4.  테스트 연동 정보 확인 후 오른쪽 하단 `저장` 버튼 클릭

    * mid : `2999199999`
    * apiKey : `Mjk5OTE5OTk5OTpNQTAxOkE0RTc2QkRBMzM3RENDQTk1Mjk4RkI0OTVBODREMzY5`

    <figure><img src="/gitbook-assets/ko/ksnet-setup-test-2.png" alt=""/><figcaption></figcaption></figure>
...
3.  결제 대행사 설정에서 KSNET / KSNET (또는 KSNET API) 선택 후 오른쪽 `+ 추가` 버튼 클릭\\
    ...
    * 비인증결제: KSNET API
    ...
    <figure><img src="/gitbook-assets/ko/ksnet-setup.png" alt=""/><figcaption></figcaption></figure>
4.  KSNET으로부터 전달받은 실 연동 정보 입력 후 오른쪽 하단 `저장` 버튼 클릭\\

    <figure><img src="/gitbook-assets/ko/ksnet-setup-2.png" alt=""/><figcaption></figcaption></figure>
