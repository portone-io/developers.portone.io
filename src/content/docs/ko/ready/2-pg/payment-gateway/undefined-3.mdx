...
<Hint style="danger">
Paypal Express checkout 신규 신청 및 신규 연동이 불가합니다. 페이팔 연동을 원하는 경우, [페이팔 SPB(Smart Payment Buttons) 연동 방법](paypal-spb.md)으로 진행 바랍니다.
...
![](</gitbook-assets/ko/image (127).png>)
...
![](</gitbook-assets/ko/image (261).png>)
...
![](</gitbook-assets/ko/image (169).png>)
...
![](</gitbook-assets/ko/image (300).png>)

**2) NVP/SOAP API 통합(클래식) 의 API 자격증명 관리 클릭**

\- 참고 : 휴대폰본인인증 절차 필요

![](</gitbook-assets/ko/image (138).png>)
