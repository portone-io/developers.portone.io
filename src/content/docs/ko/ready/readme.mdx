...
<prose.h2 id="registration">1. 포트원 회원가입 하기</prose.h2>
...
<prose.h2 id="channel-config">3. 결제대행사 채널 설정하기</prose.h2>
    ...
    <Details id="channel-config-inicis">
      ...
      <Tabs>
        <Tab title="결제창 일반/정기 결제">
          ...
          4. INIAPI key 생성 갱신의 조회 버튼을 클릭하여 \[INIAPI KEY], \[INIAPI IV] 값을 확인할 수 있습니다. 값이 표시되지 않는 경우 갱신 버튼을 클릭해 주세요.
          ...
          6. 포트원 콘솔에서 채널 추가 시 \[상점아이디], \[웹결제 signkey]를 입력한 후 `저장`을 클릭합니다. \[INILite Key], \[INIAPI Key], \[INIAPI IV]의 값은 케이스에 따라 추가로 입력한 후 `저장`을 클릭합니다.
...
<prose.h2 id="integration-identifiers">4. 포트원 연동정보 확인하기</prose.h2>
