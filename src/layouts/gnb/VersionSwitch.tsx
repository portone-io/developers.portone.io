...
export function VersionSwitch() {
  return (
    <div class="bg-slate-2 text-slate-5 p-2px flex cursor-pointer select-none overflow-hidden break-keep rounded-full text-center font-bold shadow-[0px_1px_10px_0px_rgba(0,0,0,0.15)_inset]">
