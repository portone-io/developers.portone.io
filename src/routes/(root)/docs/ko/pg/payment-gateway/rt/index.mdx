...
<Hint style="warning">
  ...
  [연동 유의사항](/docs/ko/pg/payment-gateway/rt/warning)
</Hint>
...
결제 내역을 조회([GET /payments/\{imp\_uid}](/docs/ko/api/api-1/api-1))한 후 응답 되는 status를 보고
...
<Details>
  <Details.Summary>빌링키 발급시 STC 적용하기</Details.Summary>
