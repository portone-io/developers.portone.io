...
해당 라이브러리는 CDN<mark style="color:purple;">**([https://cdn.iamport.kr/js/iamport.payment-\{SDK-최신버전}.js](https://cdn.iamport.kr/js/iamport.payment-\{SDK-최신버전}.js)**</mark>)을 통한
