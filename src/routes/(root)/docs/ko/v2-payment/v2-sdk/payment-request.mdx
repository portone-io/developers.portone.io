...
targetVersions: ["v2"]
versionVariants:
  v1: /ko/sdk/javascript-sdk/payrq
---
...
### **`isTestChannel`** <mark style="color:orange;background-color:yellow;">**boolean**</mark> <mark style="color:gray;">(Deprecated 예정)</mark>
...
[**confirm\_process**](../../../../tip/confirm-process) **사용 시 고객사 endpoint url 설정**
