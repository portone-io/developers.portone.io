...
To open a PG's payment window, call [**JavaScript SDK**](../../sdk/javascript-sdk/readme) `IMP.request_pay`
...
<Tabs>
  <Tabs.Tab title="KG Inicis general payment window call">
    ```ts title="JavaScript"
    IMP.request_pay({
  ...
  <Tabs.Tab title="KG Inicis subscription payment window call">
    ```ts title="JavaScript"
    IMP.request_pay({
