...
<Details>
  <Details.Summary>TBU</Details.Summary>
...
<Details>
  ...
  <Details.Content>
    ...
    **Multiple PG support for identity verification**
    ...
    ### Bug Fixes <a href="#undefined" id="undefined" />
...
<Details>
  ...
  <Details.Content>
    ...
    **Added redirection mode for Danal identity verification**
    ...
    To redirect to a page after identity verification, set the target page's URL in `m_redirect_url` when calling `IMP.certification`. Previous versions only support the callback mode. For more information about using the redirection mode, refer to the [Mobile identity verification](../../etc/phone/readme) page.
...
<Details>
  ...
  <Details.Content>
    ### iamport.payment-1.1.5.js <a href="#iamportpayment-115js" id="iamportpayment-115js" />
    ...
    **Reasons for failure after starting payment process**
    ...
    ### iamport.payment-1.1.4.js <a href="#iamportpayment-114js" id="iamportpayment-114js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.1.4.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2016-11-14**
    ...
    ### iamport.payment-1.1.3.js <a href="#iamportpayment-113js" id="iamportpayment-113js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.1.3.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2016-07-13**
    ...
    ### iamport.payment-1.1.2.js <a href="#iamportpayment-112js" id="iamportpayment-112js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.1.2.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2016-03-09**
    ...
    ### iamport.payment-1.1.1.js <a href="#iamportpayment-111js" id="iamportpayment-111js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.1.1.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2016-02-19**
    ...
    ### iamport.payment-1.1.0.js <a href="#iamportpayment-110js" id="iamportpayment-110js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.1.0.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2016-01-19**
    ...
    ### iamport.payment-1.0.0.js <a href="#iamportpayment-100js" id="iamportpayment-100js" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment-1.0.0.js"
      type="text/javascript"
    ></script>
    ```
    ...
    **Deployed on 2014-10-24**
    ...
    ### iamport.payment.js <a href="#iamportpaymentjs" id="iamportpaymentjs" />

    ```html
    <script
      src="https://cdn.iamport.kr/js/iamport.payment.js"
      type="text/javascript"
    ></script>
    ```
  </Details.Content>
