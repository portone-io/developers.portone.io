...
>
> <mark style="color:red;">(returned as`imp_success` for some PG/payment method)</mark>
...
>
> - `failed` (payment failed: credit card limit exceeded, insufficient check card balance,
>   payment window closed or cancel button clicked)
...
<Details>
  <Details.Summary>Simple pay codes</Details.Summary>
