...
## Gets the details of payments by multiple imp\_uids or merchant\_uids.

<Swagger method="get" path="/payments" baseUrl="https://api.iamport.kr" summary="Gets the details of payments by imp_uids or merchant_uids.">
  <SwaggerDescription>
    **Example call**\
  ...
  <SwaggerParameter name="imp_uid[]" type="Array">
    **Transaction ID**
  </SwaggerParameter>

  <SwaggerParameter name="merchant_uid[]" type="Array">
    Order ID
  </SwaggerParameter>
  ...
  <SwaggerResponse status="200: OK" description="Success">
    <Tabs>
      <Tabs.Tab title="MultiplePaymentsResponse">
  ...
  <SwaggerResponse status="404: Not Found" description="Failed to find the transaction">
    ```ts
    {
      // Response
    }
...
<Hint style="success">
  **Swagger Test Link**
  ...
  [**https://api.iamport.kr/#!/payments/getPaymentListByImpUid**](https://api.iamport.kr/#!/payments/getPaymentListByImpUid)
</Hint>
