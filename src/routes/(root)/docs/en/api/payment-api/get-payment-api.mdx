...
## Gets the details of a payment by imp\_uid.

<Swagger method="get" path="/payments/{imp_uid}" baseUrl="https://api.iamport.kr" summary="Gets the details of a payment by imp_uid.">
  <SwaggerDescription />
...
<Hint style="success">
  **Swagger Test Link**
  ...
  [**https://api.iamport.kr/#!/payments/getPaymentByImpUid**](https://api.iamport.kr/#!/payments/getPaymentByImpUid)
</Hint>
