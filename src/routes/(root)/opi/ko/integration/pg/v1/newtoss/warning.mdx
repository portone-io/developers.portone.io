...
<Details>
  <Details.Summary>appCard 파라미터는 일부 카드사에 대해서만 적용 됨</Details.Summary>
...
<Details>
  <Details.Summary>display.card\_quota 파라미터는 다른 PG사와 다르게 동작 함</Details.Summary>
...
<Details>
  <Details.Summary>무이자 할부가 적용 되어도 ISP 계열 카드로 결제시에는 “무이자” 표기가 되지 않음</Details.Summary>
...
<Details>
  <Details.Summary>할부 기간 선택 관련 이슈</Details.Summary>
...
<Details>
  <Details.Summary>카카오페이 13개월 이상 할부 개월수 불가능한 이슈</Details.Summary>
...
<Details>
  <Details.Summary>카카오페이 일부 카드의 경우 카드 정보를 확인할 수 없는 이슈</Details.Summary>
...
<Details>
  <Details.Summary>고정 할부 개월수(card.direct.quota)를 보내지 않으면 무조건 일시불로 결제 됨</Details.Summary>
...
<Details>
  <Details.Summary>고정 할부 개월수(card.direct.quota)를 보내도 카드 결제창에서 결제 될 할부 개월수를 확인할 수 없음</Details.Summary>
...
<Details>
  <Details.Summary>페이북을 통한 ISP 계열 카드 결제시, 카드 번호가 정상적으로 내려오지 않음</Details.Summary>
...
<Details>
  <Details.Summary>사파리 브라우저에서 ISP 계열 카드 결제 불가능</Details.Summary>
...
<Details>
  <Details.Summary>가상계좌 발급 가능 은행</Details.Summary>
...
<Details>
  <Details.Summary>가상계좌 발급 완료시 예금주 명 알 수 없음</Details.Summary>
...
<Details>
  <Details.Summary>대부분의 간편결제에 대해 결제 테스트 불가능</Details.Summary>
...
<Details>
  <Details.Summary>카드 외 복합 결제 건에 대해서는 정확한 결제 수단 정보 확인 불가능</Details.Summary>
...
<Details>
  <Details.Summary>고정 할부 개월수 적용해도 일시불과 함께 표기</Details.Summary>
...
<Details>
  <Details.Summary>지출증빙 발급번호 이슈</Details.Summary>
...
<Details>
  <Details.Summary>간편결제 - SSG페이 결제시 토스페이먼츠 결제창에서 휴대폰 번호를 입력하지 않아도 다음으로 넘어가는 이슈</Details.Summary>
...
<Details>
  <Details.Summary>삼성페이 결제 중단시 결제창 잘림 현상</Details.Summary>
...
<Details>
  <Details.Summary>현금영수증 발급 API 호출시 유효성 검사를 하지 않음</Details.Summary>
...
<Details>
  <Details.Summary>사파리 / 파이어폭스 브라우저 내 팝업 블로커 이슈</Details.Summary>
...
<Details>
  <Details.Summary>IE 브라우저 - 카드결제 - 페이코 선택시 아래와 같이 결제창이 잘리는 이슈</Details.Summary>
...
<Details>
  <Details.Summary>IE 브라우저 결제 중단시 에러 메시지 인코딩 이슈</Details.Summary>
