...
targetVersions: ["v1"]
versionVariants:
  v2: /ko/integration/pg/v2/kcp-v2
---
...
[JavaScript SDK](/opi/ko/integration/sdk/javascript-sdk/readme) `IMP.request_pay(param, callback)`을 호출하여 NHN
...
<Tabs>
    ...
    **string** 이 아닌점에 유의하세요
    ...
    <Hint style="info">
      **payco 허브형**인 경우 KCP 관리자페이지 신청 및 설정이 필요합니다.
      ...
      신청안내 링크 : [https://sir.kr/main/service/p\_payco\_hub.php](http://sir.kr/main/service/p_payco_hub.php)
    </Hint>
  </Tabs.Tab>

  <Tabs.Tab title="비인증결제 연동하기(예약결제)">
    ...
    **결제금액**
    ...
    customer\_uid를 고객사 내부서버에 저장하시고 [<mark style="color:blue;">**비 인증 결제요청 REST API**</mark>](/api/rest-v1/nonAuthPayment?v=v1#post%20%2Fsubscribe%2Fpayments%2Fagain)를 호출하시면
    결제를 발생시킬 수 있습니다.
  ...
  <Tabs.Tab title="API 결제">
    ...
    REST [**API POST /subscribe/payments/onetime**](/api/rest-v1/nonAuthPayment?v=v1#post%20%2Fsubscribe%2Fpayments%2Fonetime)을 호출하여 일회성 결제를 요청합니다.
    ...
    재결제([**POST /subscribe/payments/again**](/api/rest-v1/nonAuthPayment?v=v1#post%20%2Fsubscribe%2Fpayments%2Fagain)) REST API를 다음과 같이 호출합니다.
    ...
    **자세한 가이드는 아래 링크를 참조하세요**
    ...
    <ContentRef slug="/ko/integration/start/readme-v1" />
  </Tabs.Tab>
</Tabs>
          ...
          <tbody>
            <tr style="height:27.0pt">
              <td width="114" style="background:#f2f5f9;">
                <p align="center"><b><span>카드사 포인트<span /></span></b></p>
              </td>

              <td width="123" style="background:#f2f5f9;">
                <p align="center"><b><span>포인트 할부개월<span /></span></b></p>
              </td>
            </tr>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>국민<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>비씨<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>삼성<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>하나<span>/</span>외환<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>롯데<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>신한<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>농협<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>씨티<span /></span></p>
              </td>
            ...
            <tr style="height:13.5pt">
              <td width="114">
                <p align="center"><span>우리<span /></span></p>
              </td>
...
<Tabs>
  ...
  <Tabs.Tab title="휴대폰 결제 휴대폰번호 고정">
    ```json
    {
      "prefill": {
  ...
  <Tabs.Tab title="빌링키 발급 시 생년월일 입력 박스 고정">
    ```ts
    IMP.request_pay({
      // ...
      bypass: {
