...
<Parameter flatten>
  - channelKey: string
    ...
    **채널키**
    ...
    paypal\_v2 채널의 채널 키입니다. 포트원 콘솔 내 \[결제 연동] - \[연동 정보] - \[채널 관리] 에서 확인 가능합니다.
  ...
  - customer\_uid: string
    ...
    **포트원 빌링키**
    ...
    고객사에서 빌링키 발급 시 고유하게 채번하여 요청해야 합니다. 빌링키 결제 시 해당 값을 이용하여 결제를 요청해야 하기 때문에 고객사에서 별도로 저장하셔야 합니다.

  - customer\_id?: string

    **고객 식별 아이디**

    고객사에서 구매자를 특정하기 위해 고유하게 채번하여 사용하는 아이디입니다.

  - notice\_url?: string | string\[]

    **웹훅 수신 URL**

    빌링키 발급 완료 후 웹훅이 발송됩니다.

  - custom\_data?: object

    **사용자 정의 데이터**

    빌링키 발급 정보와 함께 고객사에서 관리하고 싶은 데이터를 JSON 형식으로 저장할 수 있습니다.
</Parameter>
...
<Hint style="warning">
  **파라미터 유의사항**
  ...
  [연동 유의사항](/opi/ko/integration/pg/v1/rt/warning)
</Hint>
...
결제 내역을 조회([GET /payments/\{imp\_uid}](/api/rest-v1/payment?v=v1#get%20%2Fpayments%2F%7Bimp_uid%7D))한 후 응답 되는 status를 보고
          ...
          paypal_v2: {
            additional_data: [
              ...
              },
              {
                ...
                value: "2023-10-10T23:59:59+09:00", // ISO 8601 형식
              },
            ],
          },
        },
