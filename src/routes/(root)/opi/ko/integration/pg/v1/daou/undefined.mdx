...
<Details>
  <Details.Summary>주문명, 주문자명은 EUC-KR에서 표현 가능한 문자가 사용해야함</Details.Summary>

  <Details.Content>
    키움페이의 경우 EUC-KR 인코딩을 사용합니다. 따라서 주문자명(buyer_name), 주문명(name) 등의
...
<Details>
  <Details.Summary>복합과세 거래는 일부 결제수단에서만 가능</Details.Summary>
...
<Details>
  <Details.Summary>카카오페이, 페이코 거래 부분취소 시  취소금액 중 면세금액을 설정 불가</Details.Summary>
