...
<Tabs>
  ...
  <Details>
    <Details.Summary><strong>setupPassword 설명</strong></Details.Summary>
  ...
  <Details>
    <Details.Summary><strong>getPaymentMethods 설명</strong></Details.Summary>
  ...
  <Details>
    <Details.Summary><strong>openSettings 설명</strong></Details.Summary>
