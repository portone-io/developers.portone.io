---
title: 나이스정보통신 (구모듈)
description: 나이스정보통신 (구모듈) 결제창 연동 가이드를 안내합니다.
targetVersions: ["v1"]
---
    ...
    <Parameter flatten>
      ...
      - vbank\_due?: string
        ...
        **가상계좌 입금마감일시**
        ...
        `YYYYMMDD` 또는 `YYYYMMDDHHmm` 형식으로 지정합니다. 미지정 시 기본 30일입니다.
        ...
        **나이스정보통신(구모듈) 전용 파라미터**
        ...
        <Parameter.Details>
          - CardShowOpt?: string
            ...
            **카드사별 호출 방식** (모바일 전용, `niceMobileV2: true` 시에만 동작)
        ...
        <Parameter.Details>
          - card\_quota: number[]
            ...
            **할부 개월수**
            ...
            - `[]`: 일시불만 결제 가능
            - `[2, 3, 4, 5, 6]`: 일시불을 포함한 2, 3, 4, 5, 6개월 할부 선택 가능
            - `[3]`: 일시불과 3개월 할부만 선택 가능

            배열에 포함된 개월수만 개별적으로 활성화됩니다.
        </Parameter.Details>
    </Parameter>
