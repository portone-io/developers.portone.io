  ...
  <Tabs.Tab title="서비스 유저 등록">
    ...
    IMP.request_pay(
    {
      ...
      bypass: {
        kcpQuick: {
          // KCP 퀵페이 파라미터
          actionType: "SignUp", // KCP 간편결제, 선불머니 서비스 유저 등록
          encryptedCI: "encrypted_ci", // 본인인증 후 전달받은 CI를 암호화한 값
          memberID: "use_your_unique_id", //사용자에 대한 고유 식별값
        },
      },
      m_redirect_url: "https://redirection.url", //  유저 등록 후 리디렉션될 URL
    },
    function (rsp) {
      // callback 로직
      //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", //결제수단 삭제 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", //결제 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", //PIN 변경 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", //PIN 초기화 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", //전화번호 변경 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
    ...
    IMP.request_pay(
      {
        ...
        m_redirect_url: "https://testtest.test", // 해지 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
...
<Tabs>
  <Tabs.Tab title="환불계좌 등록 및 변경">
    ```ts
    IMP.request_pay(
      {
        channelKey: "{콘솔 내 연동 정보의 채널키}",
        pay_method: "card", // card 입력
        merchant_uid: "order_no_0001", //상점에서 생성한 고유 주문번호
        name: "환불계좌 등록 및 변경 테스트", //주문명
        amount: 0,
        buyer_email: "test@portone.io",
        buyer_name: "구매자이름",
        buyer_tel: "010-1234-5678",
        ...
        bypass: {
          kcpQuick: {
            //KCP퀵페이 설정 정보
            actionType: "RefundAccount", //유저 및 결제수단 삭제
            encryptedCI: "encrypted_ci", // 본인인증 후 전달받은 CI를 암호화한 값
            memberID: "use_your_unique_id", // 사용자에 대한 고유 식별값
          },
        },
        m_redirect_url: "https://testtest.test", // 환불계좌 등록 및 변경 후 리디렉션될 URL
      },
      function (rsp) {
        // callback 로직
        //* ...중략... *//
...
<Hint style="info">
  ...
  - `kcp_action` : Register 또는 Deregister 또는 Pay
