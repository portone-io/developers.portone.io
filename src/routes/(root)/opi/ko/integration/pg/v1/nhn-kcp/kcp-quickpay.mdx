...
<Tabs>
  <Tabs.Tab title="선불머니 현장결제 상세내역 조회 요청">
            ...
            **선불머니 현장결제 내역 상세 조회 요청**
            ...
            - btid: string
              ...
              **고객사 생성 거래 등록번호**
              ...
              거래 상세 조회 요청 시 고객사에서 `btid` 값을 생성하여 전달해 주시기 바랍니다.
              전달해 주신 `btid` 값으로 KCP에서 고객사 서버를 호출하여 유효성 검증이 진행됩니다.
        </Parameter.Details>
    </Parameter.Details>
</Parameter>
...
<Details>
  <Details.Summary>선불머니 기능 이용 시 선불머니 거래사전 등록 API 선행 필요</Details.Summary>

  <Details.Content>
    선불머니 관련 기능을 이용하기 위해서는
    [**선불머니 거래사전 등록 API**](/api/rest-v1/pg.kcpquick?v=v1#post%20%2Fkcpquick%2Fprepare%2F%7Bmerchant_uid%7D)가 반드시 선행되어야 합니다.
