...
<Details>
  <Details.Summary>파라미터 예제 코드</Details.Summary>
...
<Details>
  <Details.Summary>고객사 설정 정보와 다른 `digital` 파라미터가 입력 된 경우</Details.Summary>
...
<Details>
  <Details.Summary>V1 에스크로 + 카드사 다이렉트 호출</Details.Summary>
...
<Details>
  <Details.Summary>V2 에스크로 + 카드사 다이렉트 호출</Details.Summary>
...
<Details>
  <Details.Summary>V2 에스크로 + 가상계좌 다이렉트 호출</Details.Summary>
...
<Details>
  <Details.Summary>V1 에스크로 + 계좌이체 + 현금영수증 정보 전달</Details.Summary>
...
<Details>
  <Details.Summary>V2 에스크로 + 계좌이체 + 현금영수증 정보 전달</Details.Summary>
