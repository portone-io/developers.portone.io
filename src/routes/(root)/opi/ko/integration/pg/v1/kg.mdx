...
<Hint style="info">
  - 비 인증 결제를 위해서는 **KG파이낸셜와 계약이 완료된 MID 정보를** 관리자콘솔에 설정하셔야 비 인증 결제창을 활성화시킬 수 있습니다.
...
- pg(deprecated)?: string
  ...
  **`mobilians.<KG파이낸셜와 계약이 완료된 MID>`** 로 지정하면 됩니다.
...
**포트원을 통해 KG파이낸셜를 사용할 때에는 API 방식 비 인증 결제를 사용할 수 없습니다.**
