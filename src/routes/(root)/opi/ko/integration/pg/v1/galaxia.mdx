  ...
  <Tabs.Tab title="일반 결제 창 요청">
    ...
    <Parameter flatten>
      ...
      - cashReceiptType?: string
        ...
        **현금영수증 발급 용도**
        ...
        간편결제, 계좌이체 결제시 현금영수증 발급 용도를 지정합니다.
      ...
      - customerIdentifier?: string
        ...
        **현금영수증 발급 식별번호**
        ...
        간편결제, 계좌이체 결제시 휴대폰번호 또는 사업자번호를 입력합니다.
    ...
    <Hint style="warning">
      **미지원 파라미터**
      ...
      갤럭시아에서는 다음 파라미터가 지원되지 않습니다.

      - `card.detail` (카드사 노출 설정)
      - `useCardPoint` (카드사 다이렉트 미호출 시 카드 포인트 사용 여부)
    </Hint>
