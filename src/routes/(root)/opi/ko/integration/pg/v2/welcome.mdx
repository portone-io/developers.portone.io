    ...
    <Parameter.Details>
      - welcome?: WelcomeBypassOnPc & WelcomeBypassOnMobile
        ...
        **웰컴페이먼츠 bypass 파라미터**
        ...
        <Parameter.Details>
          <Parameter.TypeDef type="WelcomeBypassOnPc">
            **PC용 파라미터**
            ...
            <Parameter.Details>
              ...
              - acceptmethod?: string\[]
                ...
                **PC - 카드 결제 전용 파라미터**
                ...
                |onlyeasypaycode(간편 결제 리스트)|카드 결제창 내 렌더링 될 간편 결제 리스트 <br /> 예) 카카오페이, 엘페이, 페이코만 렌더링 → ”kakaopay:lpay:payco” 전달 <br /> - 카카오페이: `kakaopay` <br /> - 엘페이: `lpay` <br /> - 페이코: `payco` <br /> - 토스페이: `tosspay` <br /> - 네이버페이: `npay`|
          ...
          <Parameter.TypeDef type="WelcomeBypassOnMobile">
            **모바일용 파라미터**
...
<Details>
  <Details.Summary>PC와 모바일에서 파라미터 필수 여부가 상이합니다.</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하는 현금영수증 발급 유형</Details.Summary>
...
<Details>
  <Details.Summary>카드사 다이렉트 호출 시 할부 개월 수 옵션은 고정 할부 개월 수만 지원합니다.</Details.Summary>
...
<Details>
  ...
  <Details.Content>
    ...
    [JS SDK 결제요청 파라미터](/sdk/ko/v2-sdk/payment-request) 페이지에서 `card` -> `cardCompany` 필드 설명을 참고해주세요.
  </Details.Content>
</Details>

<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 카드 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하는 간편결제사 종류</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 간편결제 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 계좌이체 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 가상계좌 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하는 상품권 종류 및 필수 여부</Details.Summary>
...
<Details>
  <Details.Summary>결제창에 노출될 통신사 리스트 지정 옵션 지원 여부</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 휴대폰 소액결제 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>`issueId` 에는 ASCII 문자만 허용됩니다.</Details.Summary>
...
<Details>
  <Details.Summary>`offerPeriod` 파라미터 제약 사항</Details.Summary>
...
<Details>
  <Details.Summary>카드사 다이렉트 호출을 지원하지 않습니다.</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 지원하지 않는 빌링키 발급 및 결제 파라미터</Details.Summary>
        ...
        <Parameter.Details>
          - bank: string
            ...
            **발급 은행**
            ...
            - [BANK ENUM 바로가기](/api/rest-v2/payment#Bank)
...
<Details>
  <Details.Summary>웰컴페이먼츠 필수 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>웰컴페이먼츠에서 에스크로 배송 등록시 필수 파라미터</Details.Summary>
