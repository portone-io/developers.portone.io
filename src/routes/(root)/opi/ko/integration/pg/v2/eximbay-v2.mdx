        ...
        <Parameter.Details>
          ...
          - ship\_to?: object
            ...
            **배송지 정보**
            ...
            <Hint style="warning">
              PayPal 실물 상품 결제, 혹은 디지털/실물 상품 혼합 결제 시 필수입니다.
            </Hint>
          ...
          - bill\_to?: object
            ...
            **청구지 정보**
            ...
            Klarna 결제 시 구매자의 정확한 주소 정보를 필수로 전달해야 합니다.
            ...
            <Parameter.Details>
              - ispp?: object
                ...
                **PayPal ISPP 정보**
                ...
                기본적으로 모든 하위 값이 필수이며, 전송이 불가능한 값이 있는 경우 엑심베이에 사전 문의해야 합니다.

                <Parameter.Details>
                  - sender\_account\_id?: string

                    **고객사의 구매자 고유 ID**

                  - sender\_first\_name?: string

                    **구매자 이름**

                  - sender\_last\_name?: string
...
- Klarna 결제 시 `bypass.eximbay_v2.bill_to` 항목에 구매자의 정확한 주소를 전송해야 합니다.
