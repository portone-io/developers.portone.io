          ...
          <Details.Content>
            ...
            - cp\_callback: string
              ...
              **CP 지정 callback 번호**
              ...
              <Hint style="warning">
                과학기술정보통신부 및 한국인터넷진흥원, 이동통신사의 불법스팸 대응 조치에 따라 아래 발신번호는 사용 불가능합니다.

                - 무효번호 (실제 사용되고 있지 않은 결번 또는 해지/이용정지된 유선번호 및 이동전화번호)
                - 인터넷 국번 (070, 060 등 / 유효한 인터넷 국번이더라도 통신사 정책으로 사용불가)
              </Hint>
          </Details.Content>
        </Details>
    </Parameter>
...
<Hint style="warning">
  과학기술정보통신부 및 한국인터넷진흥원, 이동통신사의 불법스팸 대응 조치에 따라 아래 발신번호는 `cp_callback` 값으로 사용 불가능합니다.
