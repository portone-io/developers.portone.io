...
- <Parameter.Ref content={<SDKParameter path="#/resources/request/PaymentRequest" ident="virtualAccount.accountExpiry" />}>virtualAccount.accountExpiry</Parameter.Ref>
