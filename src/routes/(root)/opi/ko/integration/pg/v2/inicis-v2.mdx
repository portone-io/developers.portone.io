    ...
    <Parameter.Details>
      - inicis\_v2?: InicisV2BypassOnPc & InicisV2BypassOnMobile
        ...
        **이니시스 bypass 파라미터**
        ...
        <Parameter.Details>
          <Parameter.TypeDef type="InicisV2BypassOnPc">
            **PC용 파라미터**
          ...
          <Parameter.TypeDef type="InicisV2BypassOnMobile">
            **모바일용 파라미터**
...
<Details>
  <Details.Summary>계약 사항에 따라 결제 정보에서 카드 정보가 누락될 수 있습니다.</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하는 현금영수증 발급 유형</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 카드 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하는 간편결제사 종류</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 간편결제 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 계좌이체 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 가상계좌 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하는 상품권 종류 및 필수 여부</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 휴대폰 소액결제 관련 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 지원하지 않는 빌링키 발급 및 결제 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스 필수 파라미터</Details.Summary>
...
<Details>
  <Details.Summary>이니시스에서 에스크로 배송 등록시 필수 파라미터</Details.Summary>
