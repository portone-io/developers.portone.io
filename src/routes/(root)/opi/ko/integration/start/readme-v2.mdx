...
targetVersions: ["v2"]
versionVariants:
  v1: /ko/integration/start/readme-v1
---
...
바로 결제를 진행하고 싶은 것이 아니라 미래 특정 시점에 결제가 일어나게 하고 싶다면 [결제 예약하기](.#1-결제-예약하기)을 참고하세요.
...
웹훅을 받아 결제 결과를 확인하는 방법은 [웹훅 연동하기](/opi/ko/integration/webhook/readme-v2)를 참고해주세요.
