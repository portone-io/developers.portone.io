...
전체 필드 목록은 [requestPayment 응답 형식](/sdk/ko/v2-sdk/payment-response)을 참조해 주시기 바랍니다.
...
서버는 포트원의 [결제 조회 API](/api/rest-v2/payment#get%20%2Fpayments%2F%7BpaymentId%7D)를
