...
import IntegrationPayletter from "./_components/integration-guide/payletter.mdx";
...
<Details id="channel-config-payletter">
  <Details.Summary>페이레터</Details.Summary>

  <Details.Content>
    <IntegrationPayletter />
  </Details.Content>
</Details>
