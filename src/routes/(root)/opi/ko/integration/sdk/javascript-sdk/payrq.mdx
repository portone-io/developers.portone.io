...
targetVersions: ["v1"]
versionVariants:
  v2: /ko/integration/v2-sdk/payment-request
---
...
[**각 PG사별 결제 연동 가이드**](/opi/ko/integration/pg/v1/readme)를 참고하세요
...
### **`products`** <mark style="color:blue;">**array**</mark>
...
- **code** : 카드사 금융결제원 표준 코드. [카드사 코드](/opi/ko/support/code-info/card-code) 참조 (**string**)
