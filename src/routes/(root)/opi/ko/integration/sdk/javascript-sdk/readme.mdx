...
targetVersions: ["v1"]
versionVariants:
  v2: /ko/integration/v2-sdk/readme
---

import Hint from "~/components/Hint";

<Hint style="info">
  기존에 사용하신 JavaScript SDK의 문서를 원하시면 [javascript-sdk-old](/opi/ko/integration/sdk/javascript-sdk-old/readme)를 참고해주세요.
</Hint>
...
<Hint style="danger">
  **success**나 **error\_code**는 **결제 성공 여부를 나타내지 않습니다.**
  ...
  포트원 REST API로 [결제 상세 내역을 조회](/api/rest-v1/payment?v=v1#get%20%2Fpayments%2F%7Bimp_uid%7D)해야 결제 성공 여부를 받을 수 있습니다.

  자세한 내용은 [인증 결제 연동하기 - 결제 완료 처리하기](/opi/ko/integration/start/v1/auth?v=v1#4-결제-완료-처리하기-)를 참고해주세요.
</Hint>
