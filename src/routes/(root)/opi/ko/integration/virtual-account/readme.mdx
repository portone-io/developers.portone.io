...
<VersionGate v="v1">
  ...
  |나이스정보통신(구모듈)|nice                |[https://service.iamport.kr/nice\_payments/notice\_vbank](http://service.iamport.kr/nice_payments/notice_vbank)                                                                                                                                                            |
  |나이스정보통신(신모듈)|nice\_v2            |[https://tx-gateway-service.prod.iamport.co/nicepay-v2](http://tx-gateway-service.prod.iamport.co/nicepay-v2)                                                                                                                                                              |
...
<VersionGate v="v2">
  ...
  |나이스정보통신  |nice\_v2            |[https://tx-gateway-service.prod.iamport.co/nicepay-v2](http://tx-gateway-service.prod.iamport.co/nicepay-v2)                                                                | |
...
<VersionGate v="v1">
  <Details id="notice-config-inicis">
    ...
    <Details.Content>
      ...
      <Figure src={inicie_image1} caption="KG이니시스 가맹점관리자 내 입금통보 URL 설정 화면" />
    </Details.Content>
  </Details>
  ...
  <Details id="notice-config-nice">
    <Details.Summary>나이스정보통신(구모듈) 설정 방법</Details.Summary>
    ...
    <Details.Content>
      ...
      <Figure src={nice_v1_image1} caption="나이스정보통신 가맹점 관리자 내 입금통보 URL 설정 화면" />
    </Details.Content>
  </Details>
...
<Details id="notice-config-nice_v2">
  <Details.Summary>나이스정보통신(신모듈) 설정 방법</Details.Summary>
  ...
  <Details.Content>
    ...
    <Figure src={nice_v2_image1} caption="나이스정보통신 가맹점 관리자 내 입금통보 URL 설정 화면 " />
  </Details.Content>
</Details>
