...
import ConfirmProcessImage1 from "./_assets/confirm_process_v2_1.png";
...
<Hint style="info">
  **수동 승인 기능 안내**
  ...
  V2 신규 연동 시에는 컨펌 프로세스와 동일한 목적으로 사용할 수 있는 [수동 승인](/opi/ko/extra/manual-confirm/readme-v2) 기능을 이용하시기를 권장합니다. 
...
<Hint style="info">
  **컨펌 프로세스 신청 방법**
  ...
  기술지원 메일([tech.support@portone.io](mailto:tech.support@portone.io))로 **상점 아이디**를 기재하여 메일 발송
...
[웹훅 연동하기 - 웹훅 요청 검증하기](/opi/ko/integration/webhook/readme-v2#웹훅-메시지-검증하기)를 참고하셔서 컨펌 웹훅을 신뢰할 수 있는지를 검사하세요.
