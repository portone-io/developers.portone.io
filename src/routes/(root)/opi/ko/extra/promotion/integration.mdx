...
<VersionGate v="v1">
  인증결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v1) 및 [결제요청 파라미터](/opi/ko/integration/sdk/javascript-sdk/payrq) 문서를 참고하시기 바랍니다.
    ...
    **카드 정보**
    ...
    <ParamTree>
      ...
      **카드사 다이렉트 호출 시 필요한 카드사 식별 값**
      ...
      카드 다이렉트 호출 시 [카드사 식별 값](/docs/ko/v2-payment/v2-sdk/payment-request?v=v2#card-object) 문서를 참조하여 프로모션과 동일한 카드사로 지정해야 합니다.
    </ParamTree>
  </ParamTree>
</VersionGate>
...
<VersionGate v="v1">
  수기(키인)결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v1) 문서를 참고하시기 바랍니다.
...
<VersionGate v="v2">
  수기(키인)결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v2) 문서를 참고하시기 바랍니다.
...
<VersionGate v="v2">
  빌링키 결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v2) 문서를 참고하시기 바랍니다.
