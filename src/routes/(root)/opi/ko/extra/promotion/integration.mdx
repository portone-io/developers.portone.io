...
<Details>
  <Details.Summary> 프로모션이 할인 적용 건 취소 옵션 사용 안내 </Details.Summary>

  <Details.Content>
    1. \[프로모션 혜택 유지] 옵션 선택하여 부분 취소 후 \[프로모션 혜택 조정]으로 취소를 시도하는 경우
       앞선 부분 취소 후 잔여 결제 금액이 속한 구간에 맞게 할인 금액이 조정되어 취소 처리됩니다.

    2. \[프로모션 혜택 조정] 옵션 선택하여 부분 취소 후 \[프로모션 혜택 유지]로 취소를 시도하는 경우
       앞선 부분 취소시 적용된 할인 정책을 기준으로 프로모션 할인 정책이 유지됩니다.
  </Details.Content>
</Details>
