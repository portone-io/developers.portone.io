...
모바일 앱에서 포트원 결제를 연동하는 방법을 안내합니다.
...
<Hint style="info">
  모바일 결제에서는 `redirectUrl` 설정이 필수입니다. 설정하지 않으면 결제 UI가 정상적으로 표시되지 않을 수 있습니다.
</Hint>
...
V2 SDK가 제공되지 않는 플랫폼(Flutter 등)에서는 아래의 직접 연동 방법을 사용하세요.

<Hint style="info">
  Flutter용 V2 공식 SDK는 아직 제공되지 않지만, WebView를 활용한 직접 연동 샘플을 제공하고 있습니다.
  [Flutter 연동 샘플](https://github.com/portone-io/portone-sample/tree/main/flutter)을 참고하세요.
</Hint>
