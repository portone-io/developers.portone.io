...
<VersionGate v="v1">
  인증결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v1) 문서를 참고하시기 바랍니다.
</VersionGate>

<VersionGate v="v2">
  인증결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v2) 문서를 참고하시기 바랍니다.
</VersionGate>
...
각 파라미터에 대한 상세한 설명은 [결제요청 파라미터](/docs/ko/v2-payment/v2-sdk/payment-request) 문서를 참고하시기 바랍니다.
...
<VersionGate v="v1">
  빌링키 결제와 관련된 자세한 내용은 [결제 연동 시작하기](/opi/ko/integration/start/readme-v1) 문서를 참고하시기 바랍니다.
</VersionGate>
