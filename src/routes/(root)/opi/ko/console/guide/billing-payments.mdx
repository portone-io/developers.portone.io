...
<ul>
  ...
  <li>
    ...
    - 예약 해지 변경 카테고리에서는 예약 해지 또는 예약일 변경을 할 수 있습니다.
      ...
      <Details>
        <Details.Summary>예약 상태 건 클릭 시 상세 조회 화면 예시</Details.Summary>
...
<ul>
  ...
  <li>
    ...
    - 재시도 재예약 카테고리에서는 해당 건을 즉시 재시도하거나 결제를 재예약할 수 있습니다.
      ...
      <Details>
        <Details.Summary>실패 상태 건 클릭 시 상세 조회 화면 예시</Details.Summary>
...
<ul>
  ...
  <li>
    ...
    - 재예약 카테고리에서는 해당 건을 다시 재예약할 수 있습니다.
      ...
      <Details>
        <Details.Summary>해지 상태 건 클릭 시 상세 조회 화면 예시</Details.Summary>
