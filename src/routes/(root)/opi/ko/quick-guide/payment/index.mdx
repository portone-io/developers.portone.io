    ...
    <Parameter flatten>
      ...
      - orderName: string
        ...
        **주문명**
        ...
        <Condition pgName={(name) => name === 'nice'}>
          <Hint style="warning">
        ...
        <Condition pgName={(name) => name === 'naver'}>
          <Hint style="warning">
      ...
      - currency: string
        ...
        **화폐**
        ...
        <Condition pgName={(name) => name === 'ksnet'}>
          <Hint style="warning">
        ...
        <Condition pgName={(name) => name === 'inicis'} when={({ payMethod }) => payMethod === 'card'}>
          <Hint style="warning">
        ...
        <Condition pgName={(name) => name === 'kakao'}>
          <Hint style="warning">
            카카오페이는 `KRW`만을 지원합니다.
          </Hint>
        </Condition>
        ...
        <Condition pgName={(name) => name === 'tosspay'}>
          <Hint style="warning">
            토스페이는 `KRW`만을 지원합니다.
          </Hint>
        </Condition>
      ...
      - payMethod: string
        ...
        **결제 수단**
        ...
        <Condition pgName={(name) => name === 'eximbay'}>
          <Hint style="warning">
        ...
        <Details>
          ...
          <Details.Content>
            ...
            <Condition pgName={(name) => ['kakao', 'naver', 'tosspay', 'hyphen'].includes(name)}>
              - 간편결제: `EASY_PAY`
            </Condition>
      ...
      <Condition pgName={(name) => name === 'eximbay'} when={({ payMethod }) => payMethod === 'card'}>
        - card?: object
          ...
          **카드 결제 추가 정보**
          ...
          <Parameter.Details>
              ...
              **단독 노출 카드사**
              ...
              <Details>
                ...
                <Details.Content>
                  ...
                  <Condition pgName={(name) => ['nice', 'smartro', 'kpn', 'inicis', 'ksnet'].includes(name)}>
                    - `KOREA_DEVELOPMENT_BANK` (KDB산업은행 카드)
                    - `KFCC` (새마을금고 카드)
                    - `SHINHYUP` (신협 카드)
                    - `EPOST` (우체국 카드)
            ...
            <Condition pgName={(name) => !['kcp', 'kpn', 'inicis'].includes(name)}>
            ...
            <Condition pgName={(name) => !['kcp', 'inicis'].includes(name)}>
                ...
                - monthOption?: object
                  ...
                  **할부 개월 수 설정**
                  ...
                  <Parameter.Details>
                    ...
                    <Condition pgName={(name) => !['kcp', 'smartro', 'inicis'].includes(name)}>
            ...
            <Condition pgName={(name) => !['kcp', 'smartro'].includes(name)}>
            ...
            <Condition pgName={(name) => !['kpn', 'inicis'].includes(name)}>
      ...
      <Condition when={({ payMethod }) => payMethod === "virtualAccount"}>
        - virtualAccount?: object
          ...
          **가상계좌 발급 추가 정보**
          ...
          <Parameter.Details>
            ...
            <Condition pgName={(name) => !['kpn', 'kcp'].includes(name)}>
            ...
            <Condition pgName={(name) => !['kcp', 'kpn'].includes(name)}>
      ...
      <Condition when={({ payMethod }) => payMethod === "transfer"}>
        - transfer?: object
          ...
          **계좌이체 추가 정보**
          ...
          <Parameter.Details>
            ...
            <Condition pgName={(name) => !['inicis', 'kcp'].includes(name)}>
              - customerIdentifier?: string
      ...
      <Condition when={({ payMethod }) => payMethod === "mobile"}>
        - mobile?: object
      ...
      <Condition when={({ payMethod }) => payMethod === "giftCertificate"}>
            ...
            - giftCertificateType?: string
              ...
              **상품권 유형**
              ...
              <Details>
                ...
                <Details.Content>
                  <Condition pgName={(name) => ['toss', 'inicis'].includes(name)}>
                    - `BOOKNLIFE` (도서문화상품권)
      ...
      <Condition when={({ payMethod }) => payMethod === "easyPay"}>
        - easyPay?: object
          ...
          **간편결제 추가 정보**
          ...
          <Parameter.Details>
            ...
            <Condition pgName={(name) => !['kpn', 'inicis', 'ksnet'].includes(name)}>
              - useFreeInterestFromMall?: boolean
            ...
            <Condition pgName={(name) => !['kpn', 'inicis', 'naver', 'tosspay', 'hyphen'].includes(name)}>
              - availableCards?: string\[]
            ...
            <Condition pgName={(name) => !['kpn', 'naverpay'].includes(name)}>
              - installment?: object
                ...
                **할부 설정**
                ...
                <Parameter.Details>
                  <Condition pgName={(name) => !['ksnet', 'kakao'].includes(name)}>
                    - freeInstallmentPlans?: object\[]
            ...
            <Condition pgName={(name) => !['kpn', 'tosspay'].includes(name)}>
              - cashReceiptType?: string
            ...
            <Condition pgName={(name) => !['kpn', 'inicis', 'tosspay'].includes(name)}>
              - customerIdentifier?: string
          ...
          <Condition pgName={(name) => name === "ksnet"}>
            - ksnet?: object
              ...
              <Parameter.Details>
                ...
                <Condition when={({ payMethod }) => payMethod === "card"}>
                  - sndQpayType?: string
      ...
      - storeDetails?: object
        ...
        **상점 정보**
        ...
        <Condition pgName={(name) => name === "ksnet"} when={({ payMethod }) => payMethod === "easyPay"}>
          <Hint style="warning">
