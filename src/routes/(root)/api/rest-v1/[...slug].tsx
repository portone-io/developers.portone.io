...
import { loadV1Schema } from "~/layouts/rest-api/schema-utils/load-schema";
...
export default function ApiV1Docs() {
  ...
  const schema = createAsync(() => loadV1Schema(), { deferStream: true });
              ...
              <Match when={currentSection() === "overview"}>
                ...
                >
                  <prose.p>
                    ...
                    하는 REST API를 제공합니다.
                    <br />
                    비인증 결제, 정기 자동결제 등 부가기능을 위한 REST API도
                    제공합니다.
                  </prose.p>
                  <V2MigrationBanner lang="ko" />
                  <Hint style="danger">
                    <prose.p>
                      2026년 1월 26일부로 포트원 V1 결제내역 단건조회 API에 동작
                      변경이 있습니다.
                    </prose.p>
                    <prose.p>
                      자세한 사항은{" "}
                  ...
                  <prose.p>
                    하위 상점에 대해 API를 사용하려는 경우 API 호출 시 Tier
                    헤더(HTTP Request Header)로 하위상점의 티어코드를 전달해야
                    합니다.
                    <br />
